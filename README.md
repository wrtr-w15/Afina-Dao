...
Для развертывания на сервере с PM2 используйте готовый скрипт:
...
**Production Checklist:** См. [PRODUCTION_CHECKLIST.md](./PRODUCTION_CHECKLIST.md)

### Ручная сборка (без PM2)
```bash
npm run build
npm start
```
